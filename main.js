...
// // 📋 Task & Ritual Handling
// function addTask() {
//     let day = parseInt(document.getElementById("modal-date").textContent.split(" ")[1]);
//     let task = document.getElementById("taskInput").value.trim();
//     if (!task) return;

//     taskData[day] = taskData[day] || { tasks: [], rituals: [] };
//     taskData[day].tasks.push(task);
...
//     taskData[day].tasks = taskData[day].tasks.filter(t => t !== task);
//     localStorage.setItem("taskData", JSON.stringify(taskData));
//     openModal(day);
// }
...
// function addToGoogleCalendar(ritual, date) {
//     const baseURL = "https://calendar.google.com/calendar/render?action=TEMPLATE";
//     const eventTitle = encodeURIComponent(`🔮 Ritual: ${ritual}`);
//     const eventDate = new Date(date);
//     const startDate = eventDate.toISOString().split("T")[0] + "T18:00:00Z"; // Default to 6 PM UTC
//     const endDate = eventDate.toISOString().split("T")[0] + "T19:00:00Z"; // 1 hour duration

//     const googleCalendarURL = `${baseURL}&text=${eventTitle}&dates=${startDate}/${endDate}`;
...
//     let ritualCategory = document.getElementById("ritualCategory").value;
...
//     li.innerHTML = `${ritualText} (${ritualCategory}) 
...
// // ✨ Function to Fetch a Random Tarot Card
// function drawCard() {
//     fetch("https://tarotapi.dev/api/v1/cards/random?n=1") // Fetch 1 random card
//         .then(response => response.json()) 
//         .then(data => {
//             if (data.cards && data.cards.length > 0) {
//                 const card = data.cards[0]; // Get the first (only) card
...
//                 console.log("Drawn Card:", card); // Debugging log
//             } else {
//                 document.getElementById("tarotResult").textContent = "No card data received!";
//             }
//         })
...
//     document.getElementById("drawTarot").addEventListener("click", () => {
//         let drawnCard = drawCard();
//         if (drawnCard) {
//             const tarotImage = document.getElementById("tarotImage");
//             tarotImage.src = drawnCard.image;
//             tarotImage.style.display = "block";

//             // Debugging: Log if the image fails to load
//             tarotImage.onerror = () => console.error("Image failed to load:", tarotImage.src);
//         }
//     });
// });

// // ✅ Tarot Deck Array with Proper Paths
// const tarotDeck = [
//     { name: "The Fool", meaning: "New beginnings, adventure, free spirit", image: "Tarot/The_Fool.png" },
//     { name: "The Magician", meaning: "Manifestation, resourcefulness, power", image: "Tarot/The_Magician.png" },
//     { name: "The High Priestess", meaning: "Intuition, wisdom, mystery", image: "Tarot/The_High_Priestess.png" },
//     { name: "The Empress", meaning: "Fertility, nurturing, abundance", image: "Tarot/The_Empress.png" },
//     { name: "The Emperor", meaning: "Authority, structure, control", image: "Tarot/The_Emperor.png" },
//     { name: "The Hierophant", meaning: "Spiritual wisdom, tradition", image: "Tarot/The_Hierophant.png" },
//     { name: "The Lovers", meaning: "Love, harmony, relationships", image: "Tarot/The_Lovers.png" },
//     { name: "The Chariot", meaning: "Willpower, success, determination", image: "Tarot/The_Chariot.png" },
//     { name: "Strength", meaning: "Courage, inner strength, patience", image: "Tarot/Strength.png" },
//     { name: "The Hermit", meaning: "Soul-searching, solitude, inner guidance", image: "Tarot/The_Hermit.png" },
//     { name: "Wheel of Fortune", meaning: "Luck, cycles, destiny", image: "Tarot/Wheel_of_Fortune.png" },
//     { name: "Justice", meaning: "Fairness, truth, law", image: "Tarot/Justice.png" },
//     { name: "The Hanged Man", meaning: "Surrender, new perspective", image: "Tarot/The_Hanged_Man.png" },
//     { name: "Death", meaning: "Endings, transformation, transition", image: "Tarot/Death.png" },
//     { name: "Temperance", meaning: "Balance, moderation, patience", image: "Tarot/Temperance.png" },
//     { name: "The Devil", meaning: "Addiction, materialism, bondage", image: "Tarot/The_Devil.png" },
//     { name: "The Tower", meaning: "Sudden change, chaos, revelation", image: "Tarot/The_Tower.png" },
//     { name: "The Star", meaning: "Hope, inspiration, serenity", image: "Tarot/The_Star.png" },
//     { name: "The Moon", meaning: "Illusions, intuition, subconscious", image: "Tarot/The_Moon.png" },
//     { name: "The Sun", meaning: "Happiness, success, vitality", image: "Tarot/The_Sun.png" },
//     { name: "Judgement", meaning: "Reflection, reckoning, awakening", image: "Tarot/Judgement.png" },
//     { name: "The World", meaning: "Completion, wholeness, accomplishment", image: "Tarot/The_World.png" }
// ];
...
//     document.getElementById("tarotResult").textContent = "🔄 Deck shuffled! Draw a card.";
// }

// // ✨ Draw a tarot card
// function drawCard() {
//     if (shuffledDeck.length === 0) {
//         document.getElementById("tarotResult").textContent = "Deck is empty! Reshuffling...";
//         shuffleDeck();
//         return null;
//     }

//     const card = shuffledDeck.pop();
//     console.log("Selected Card:", card.name); // Debugging log
//     console.log("Image Path:", card.image); // Debugging log

//     document.getElementById("tarotResult").innerHTML = `<strong>${card.name}:</strong> ${card.meaning}`;
//     return card;
// }
